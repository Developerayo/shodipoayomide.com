      ...
      <div className="row">
        <div className="col-12 col-lg-5 about-text-col">
          ...
          <div className="about-text">
            ...
            Hi, I'm Shodipo Ayomide, I lead a Global DevRel Team at Polygon, i've got about 9 years of experience in Technology and a track record in Web & Mobile Engineering, Community Management, and cross team leardership on a global scale.< br/> < br/>

            I have given talks/workshops at developer conferences around the globe at React Atlanta, FutureSync Conference, VueJS Amsterdam, VueJS Toronto, APIDAYS Hong Kong, Frontend Love Conference Amsterdam, FOSSASIA, Google Developer Groups among many, I organizer/co-organize, Developer Circles Lagos from Facebook, unStack Africa, Open-Source Community Africa, and various other communities empowering Africa and the world with Technology. < br/> < br/>
